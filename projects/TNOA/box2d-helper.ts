...
const scaleToWorld = function (a?, b?): any {
...
var scaleToPixels = function (a?, b?): any {
  var newv = new box2d.b2Vec2();
  if (a instanceof box2d.b2Vec2) {
    newv.x = a.x * scaleFactor;
    newv.y = a.y * scaleFactor;
...
const createWorld = function () {
  ...
  worldAABB.lowerBound.Set(-this.bounds, -this.bounds);
  worldAABB.upperBound.Set(this.bounds, this.bounds);
  var gravity = new box2d.b2Vec2(0, -10);

  scaleFactor = 10;

  return new box2d.b2World(gravity);
};
